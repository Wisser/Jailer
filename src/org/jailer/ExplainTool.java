...
public class ExplainTool {
    ...
    public static void explain(final EntityGraph graph, final Set<Table> tablesToIgnore, final StatementExecutor statementExecutor, final DataModel datamodel) throws Exception {
        ...
        String selectLeafs = "Select TYPE, " + graph.getUniversalPrimaryKey().columnList(null) + " From Entity E Where E.r_entitygraph=" + graph.graphID +
            " and not exists (Select * from Entity Succ Where Succ.r_entitygraph=" + graph.graphID + " and Succ.PRE_TYPE=E.TYPE and " + succEqualsE + ")";
    ...
    private static String path(final EntityGraph graph, StatementExecutor statementExecutor, String type, List<String> keys, DataModel datamodel) throws SQLException {
        ...
        String selectPredecessor = "Select PRE_TYPE, ASSOCIATION, " + graph.getUniversalPrimaryKey().columnList("PRE_") + " From Entity E Where E.r_entitygraph=" + graph.graphID +
