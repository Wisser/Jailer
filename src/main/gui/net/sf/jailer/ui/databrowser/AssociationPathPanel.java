 ...
 * @author RalfW
 */
public abstract class AssociationPathPanel extends javax.swing.JPanel {
    ...
    public AssociationPathPanel(DataModel dataModel, List<Table> path, Color depOnColor, Color hasDepColor, Color assocColor, Color ignoredColor) {
		...
		cancelButton.setIcon(UIUtil.scaleIcon(cancelButton, okIcon));
    ...
    abstract protected void onSelectionChanged();
