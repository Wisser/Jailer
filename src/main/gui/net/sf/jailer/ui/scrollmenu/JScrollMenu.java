...
public class JScrollMenu extends JMenu {
	// Covers the one in the JMenu because the method that creates it in JMenu
	// is private
	...
	/**
	 * Lazily creates the popup menu. This method will create the popup using
	 * the <code>JScrollPopupMenu</code> class.
	 */
	...
	// ////////////////////////////
	// // All of these methods are necessary because ensurePopupMenuCreated() is
	// private in JMenu
	// ////////////////////////////
	@Override
	...
	public Component[] getMenuComponents() {
		return (popupMenu == null) ? new Component[0] : popupMenu
				.getComponents();
	}
	...
	public MenuElement[] getSubElements() {
		return popupMenu == null ? new MenuElement[0]
