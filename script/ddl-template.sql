...
${create-index}${schema}jlr_enty_brthdy${table-suffix} ON ${index-table-prefix}${schema}JAILER_ENTITY${table-suffix} (r_entitygraph, birthday, type) ${create-index-suffix};
${for-each:column-list}${create-index}${schema}jlr_enty_upk${table-suffix}$i ON ${index-table-prefix}${schema}JAILER_ENTITY${table-suffix} (r_entitygraph $, type) ${create-index-suffix};
${end}
...
${for-each:column-list}${create-index}${schema}jlr_pk_set${table-suffix}$i ON ${index-table-prefix}${schema}JAILER_SET${table-suffix} (set_id $, type) ${create-index-suffix};
${end}
...
${for-each:column-list-from}${create-index}${schema}jlr_dep_from${table-suffix}$i ON ${index-table-prefix}${schema}JAILER_DEPENDENCY${table-suffix} (r_entitygraph, assoc $) ${create-index-suffix};
${end}
${for-each:column-list-to}${create-index}${schema}jlr_dep_to${table-suffix}$i ON ${index-table-prefix}${schema}JAILER_DEPENDENCY${table-suffix} (r_entitygraph $) ${create-index-suffix};
${end}
