...
## Features
 ...
 - AI Extraction Model Assistant. Describe in natural language what data to extract. The AI generates the subject table, WHERE condition, and association restrictions.
...
## News
 ...
 - 2026-06-25    AI Extraction Model Assistant: Describe in natural language what data to extract. The AI generates the subject table, WHERE condition, and association restrictions. Requires a capable model such as deepseek/deepseek-r1.
